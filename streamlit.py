...
@st.cache_data# 3al4n eldata mat3ot4 kol 4wia t7mel mn awel w gded y3ni save automatic
def get_data():
    df = pd.read_csv(r'C:\Users\Mohmammed ahmed\Downloads\rwad masr\projects\Machine learning\weather in Australia\archive (4)\dashboard(streamlit)\Rain_AUS.csv')
    return df
